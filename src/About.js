          ...
          <div className="About_sub">
            <div className="Text">
              ...
              <p>
                ...
                SNP templates will yield increased fluorescence relative to WT templates or negative controls. We demonstrated this assay with several RNA targets, including 
                an infectious mutation in the SARS-CoV-2 Spike protein. The mutated sequence was clearly distinguishable from the original, as well as the non-template background.
              </p>
            </div>
            <div className="Images">
